  ...
  <div class="container-fluid text-center bg-light">
    ...
    <div class="row">
      <div class="col rounded-2">
        <div class="row">
          <div class="col-sm-6 bg-light vh-100">
            <form>
              <br>
              <p id="prodserv-header">Register</p>
              <p id="partner-body"> Please fill in this form to create an account.</p>
              ...
              <p id="partner-body">Your information will be kept in accordance to the 2012 Philippine Data
                Privacy Act.</p>
              <button type="submit" class="btn btn-outline-primary-light">Register</button>
            </form>
          </div>
          <div id="signup-image" class="col rounded-2 m-3">
          </div>
        </div>
      </div>
    </div>
